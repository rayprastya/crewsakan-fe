...
const Sidebar = ({ foods }) => {
  ...
  <div className="sidebar h6 shadow-sm bg-primary-subtle" id="sidebar">
        ...
        <a href="#"><i className="fas fa-home"></i><span className="ms-3 d-none d-sm-block">Utama</span></a>
        <a href="#"><i className="fas fa-check"></i><span className="ms-3 d-none d-sm-block">Rencana Masak</span></a>
